...
Route::get('promocode/voucher/{id}', 'PromocodeController@viewVoucherLayout')->name('promocode.voucher');
Route::get('promocode/voucher/{id}/voucherPrint', 'PromocodeController@printVoucher')->name('promocode.voucherPrint');
